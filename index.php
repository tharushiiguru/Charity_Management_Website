...
if(isset($_POST['signin']))
{
	...
	$sql ="SELECT * FROM tbldonor where EmailId ='$username' AND Password ='$password'";
...
<head>
	...
	<!-- Site favicon -->
	<link rel="apple-touch-icon" sizes="180x180" href="../vendors/images/donate.png">
	<link rel="icon" type="image/png" sizes="32x32" href="../vendors/images/donate.png">
	<link rel="icon" type="image/png" sizes="16x16" href="../vendors/images/donate.png">
	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="vendors/images/donate" alt="" style="width: 50px; height: 50px;">
				</a>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="vendors/images/donate.png" alt="">
				</div>
